...
public class Main {
   ...
   //     ListaString a =facade.getSiguiente("ExpresionMulPrima");
...
//        System.out.println("looooooooooooooool");
        ...
        facade.AnalisisSintactico("declarar int contador newline contador = 5 newline mover 2 contador newline newline");
